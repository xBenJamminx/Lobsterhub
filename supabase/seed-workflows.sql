-- LobsterHub Workflow Seed Data
-- Run this in Supabase SQL Editor to add/update all 50 workflows
-- Uses UPSERT (INSERT ON CONFLICT UPDATE) so it's safe to run multiple times

INSERT INTO workflows (slug, name, description, long_description, author, author_url, yaml, required_skills, category, tags, downloads, featured, status) VALUES
-- Productivity (1-15)
(
  'today-reminders',
  'Today''s Reminders',
